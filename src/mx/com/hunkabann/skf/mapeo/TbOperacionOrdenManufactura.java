...
public class TbOperacionOrdenManufactura implements java.io.Serializable {
	...
	/** full constructor */
	public TbOperacionOrdenManufactura(Integer nukIdOperacionOm,
			TbUsuario tbUsuario, TbUbicacionProcesoOm tbUbicacionProcesoOm,
			TbOrdenManufactura tbOrdenManufactura, TbEmpresa tbEmpresa,
			Integer nuCantidad, Timestamp dtFecha, Double nuHora,
			String chCodigoScrap, Integer nuScrap, String chCodigoFtq,
	...
	public void setTbUbicacionProcesoOm(
			TbUbicacionProcesoOm tbUbicacionProcesoOm) {
		this.tbUbicacionProcesoOm = tbUbicacionProcesoOm;
	}
