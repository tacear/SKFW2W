...
public class TbUsuario  implements java.io.Serializable {
    ...
    /** full constructor */
    public TbUsuario(Integer nukIdUsuario, TbPersona tbPersona, TbPerfil tbPerfil, String chUsuario, String chPassword, Timestamp dtFechaAlta, Timestamp dtFechaExpira, Boolean nuSession, Boolean nuActivo, Integer nuIntentos, Set tbEntregaRecepcionsForNukIdUsuarioRecibe, Set tbOperacionOrdenManufacturas, Set tbOrdenManufacturas, Set tbEntregaRecepcionsForNukIdUsuarioEntrega) {
        this.nukIdUsuario = nukIdUsuario;
    ...
    public void setTbEntregaRecepcionsForNukIdUsuarioRecibe(Set tbEntregaRecepcionsForNukIdUsuarioRecibe) {
        this.tbEntregaRecepcionsForNukIdUsuarioRecibe = tbEntregaRecepcionsForNukIdUsuarioRecibe;
    }
    ...
    public void setTbEntregaRecepcionsForNukIdUsuarioEntrega(Set tbEntregaRecepcionsForNukIdUsuarioEntrega) {
        this.tbEntregaRecepcionsForNukIdUsuarioEntrega = tbEntregaRecepcionsForNukIdUsuarioEntrega;
    }
