...
public class TbOrdenManufactura implements java.io.Serializable {
	...
	/** full constructor */
	public TbOrdenManufactura(Integer nukIdOrdenManufactura,
			TbUsuario tbUsuario, TbPlanControl tbPlanControl,
			TbEmpresa tbEmpresa, TbProductoTerminado tbProductoTerminado,
			TbCatStatus tbCatStatus, String chOrdenManufactura, String chPack,
			Integer nuTotal, Double nuHrsOrden, Double nuDiasSurtido,
			Double nuPiezasXhora, Timestamp dtFechaAlta, Timestamp dtFechaMod,
			Boolean nuActivo, Integer nuValidaMp, Integer nuValidaHule,
			Timestamp dtFechaPlaneacion, Set tbPlacaOms,
			Set tbOperacionOrdenManufacturas, Set tbEntregaRecepcions) {
		this.nukIdOrdenManufactura = nukIdOrdenManufactura;
