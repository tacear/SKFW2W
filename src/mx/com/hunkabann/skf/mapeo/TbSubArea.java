...
public class TbSubArea  implements java.io.Serializable {
    ...
    /** full constructor */
    public TbSubArea(Integer nukIdSubArea, TbArea tbArea, String chClave, String chNombre, String chDescripcion, Boolean nuActivo, Set tbPlacas, Set tbUbicacionProcesoOms) {
        this.nukIdSubArea = nukIdSubArea;
        this.tbArea = tbArea;
