...
public class TbUbicacionPlaca  implements java.io.Serializable {
    ...
    /** full constructor */
    public TbUbicacionPlaca(Integer nukIdUbicaPlaca, TbEmpresa tbEmpresa, String chRack, String chPasillo, String chLocacion, Boolean nuActivo, Set tbPlacaUbicacionPs) {
        this.nukIdUbicaPlaca = nukIdUbicaPlaca;
