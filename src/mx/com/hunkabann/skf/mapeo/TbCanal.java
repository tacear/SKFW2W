...
public class TbCanal  implements java.io.Serializable {
    ...
    /** full constructor */
    public TbCanal(Integer nukIdCanal, TbEmpresa tbEmpresa, String chClave, String chNombre, String chDescripcion, Timestamp ctFechaAlta, Boolean nuActivo, Set tbUbicacionProcesoOms) {
        this.nukIdCanal = nukIdCanal;
