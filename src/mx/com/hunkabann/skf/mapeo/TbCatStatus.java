...
public class TbCatStatus  implements java.io.Serializable {
    ...
    /** full constructor */
    public TbCatStatus(Integer nukIdStatus, TbEmpresa tbEmpresa, String chClave, String chNombre, String chDescripcion, Boolean nuActivo, Set tbOrdenManufacturas) {
        this.nukIdStatus = nukIdStatus;
