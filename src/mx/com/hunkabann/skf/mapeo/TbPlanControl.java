...
public class TbPlanControl  implements java.io.Serializable {
    ...
    /** full constructor */
    public TbPlanControl(Integer nukIdPlanControl, TbTipoPlanControl tbTipoPlanControl, String chClave, String chNombre, String chNumParte, String chPlanControl, Timestamp dtFechaAlta, String filePdf, Boolean nuActivo, Set tbProcesos, Set tbOrdenManufacturas) {
        this.nukIdPlanControl = nukIdPlanControl;
