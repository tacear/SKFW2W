...
public class TbUbicacionProcesoOm  implements java.io.Serializable {
    ...
    /** full constructor */
    public TbUbicacionProcesoOm(Integer nukIdUbicaProcessOm, TbMaquinaDispositivo tbMaquinaDispositivo, TbProceso tbProceso, TbCanal tbCanal, TbTipoLocacion tbTipoLocacion, TbSubArea tbSubArea, Set tbOperacionOrdenManufacturas) {
        this.nukIdUbicaProcessOm = nukIdUbicaProcessOm;
    ...
    public void setTbMaquinaDispositivo(TbMaquinaDispositivo tbMaquinaDispositivo) {
        this.tbMaquinaDispositivo = tbMaquinaDispositivo;
    }
