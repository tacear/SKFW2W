...
public class TbMateriaPrima  implements java.io.Serializable {
    ...
    /** full constructor */
    public TbMateriaPrima(Integer nukIdMateriaPrima, TbEmpresa tbEmpresa, TbCatUm tbCatUm, String chSku, String chDescripcion, Double nuCostoPromedio, Timestamp dtFechaAlta, Timestamp dtFechaModifica, Boolean nuActivo, Set tbEntregaRecepcions, Set tbProdTermMatPrims) {
        this.nukIdMateriaPrima = nukIdMateriaPrima;
