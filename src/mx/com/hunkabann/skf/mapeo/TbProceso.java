...
public class TbProceso  implements java.io.Serializable {
    ...
    /** full constructor */
    public TbProceso(Integer nukIdProceso, TbEmpresa tbEmpresa, String chNumProceso, String chNombre, String chDescripcion, Timestamp dtFechaAlta, Boolean nuActivo, Set tbUbicacionProcesoOms, Set tbPlanControls) {
        this.nukIdProceso = nukIdProceso;
