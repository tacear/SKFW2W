...
public class TbEmpresa  implements java.io.Serializable {
    ...
    /** full constructor */
    public TbEmpresa(Integer nukIdEmpresa, TbCorporativo tbCorporativo, String chClave, String chNombre, String chDescripcion, String chResidenciaFiscal, String chRegimenFiscal, Boolean nuActivo, Set tbProcesos, Set tbRols, Set tbUbicacionPlacas, Set tbMaquinaDispositivos, Set tbTipoLocacions, Set tbConfiguracions, Set tbProductoTerminados, Set tbAreas, Set tbCatCodigoFtqs, Set tbOrdenManufacturas, Set tbEntregaRecepcions, Set tbTipoPersonas, Set tbPlacaProdTerms, Set tbCatStatuses, Set tbCatUms, Set tbCanals, Set tbOperacionOrdenManufacturas, Set tbPerfils, Set tbCatCodigoScraps, Set tbMateriaPrimas, Set tbCatCodigoDownTimes, Set tbTipoPlacas, Set tbTipoPlanControls, Set tbPlacas) {
        this.nukIdEmpresa = nukIdEmpresa;
