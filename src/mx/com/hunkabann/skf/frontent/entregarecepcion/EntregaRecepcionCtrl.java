package mx.com.hunkabann.skf.frontent.entregarecepcion;
...
public class EntregaRecepcionCtrl extends GFCBaseCtrl {

	private transient final static Logger logger = Logger.getLogger(EntregaRecepcionCtrl.class);
